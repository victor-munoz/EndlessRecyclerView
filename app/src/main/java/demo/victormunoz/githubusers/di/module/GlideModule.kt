...
import demo.victormunoz.githubusers.network.image.GlideService
...
class GlideModule {
    ...
    @Provides
    @ActivityScope
    internal fun provideGlideService(glide: RequestManager, requestOptions: RequestOptions): ImageService {
        return GlideService(glide, requestOptions)
    }
